...
//нннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннннн
double        LotExponent = 3.84;  // умножение лотов в серии по експоненте для вывода в безубыток. первый лот 0.1, серия: 0.15, 0.26, 0.43 ...
extern double TakeProfit = 10.0;  // тейк профит
extern double PipStep    = 40.0;  // шаг колена
...
int start() {
   ...
   if (TradeNow && total < 1) {
      ...
      if (!ShortTrade && !LongTrade) {
         ...
         iLots = NormalizeDouble(Lots * MathPow(LotExponent, NumOfTrades), lotdecimal);
         if (PrevCl > CurrCl) {
            if (iRSI(NULL, PERIOD_H1, 7, PRICE_CLOSE, 1) < 50.0) { //больше  >
            ...
            if (iRSI(NULL, PERIOD_H1, 7, PRICE_CLOSE, 1) > 50.0) { // меньше  <
   ...
   case 2:
      for (l_count_68 = 0; l_count_68 < li_72; l_count_68++) {
          ...
          if (AccountBalance()-AccountEquity()>0)
         {
            ...
            Print("Открытие ордера с лотом: ",pLots);           
         }
