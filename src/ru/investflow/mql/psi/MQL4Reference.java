 ...
 */
public class MQL4Reference extends PsiReferenceBase<PsiNamedElement> implements PsiPolyVariantReference {
    private final String name;

    public MQL4Reference(@NotNull PsiNamedElement element, TextRange textRange) {
    ...
    public ResolveResult[] multiResolve(boolean incompleteCode) {
        ...
        List<PsiNamedElement> namedElements = Collections.emptyList();//TODO: MQL4Util.findDefinitionNode(project, name, myElement);
