...
public class MQL4TokenSets implements MQL4Elements {
    ...
    public static final TokenSet LITERALS = TokenSet.create(STRING_LITERAL, CHAR_LITERAL, INTEGER_LITERAL, DOUBLE_LITERAL, INCLUDE_STRING_LITERAL, FALSE_KEYWORD, TRUE_KEYWORD, COLOR_LITERAL);
